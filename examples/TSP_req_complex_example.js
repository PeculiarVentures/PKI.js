  ...
  */
   ...
   */
    ...
    */
	...
	//*********************************************************************************
	context("TSP Request Complex Example", function () {
		it("Create And Parse TSP Request", function () {
			return createTSPReqInternal().then(function () {
				var asn1 = fromBER(tspReqBuffer);
