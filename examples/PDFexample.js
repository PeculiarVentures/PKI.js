...
(function () {
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["contentType", "content"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["eContentType", "eContent"]);
			//endregion
  ...
  */
   ...
   */
		...
		isCertificateRevoked(certificate) {
			...
			try {
				for (var _iterator22 = this.revokedCertificates[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
					var revokedCertificate = _step22.value;
   ...
   */
		verify() {
			...
			if ("crlExtensions" in this) {
				...
				try {
					for (var _iterator23 = this.crlExtensions.extensions[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
						var extension = _step23.value;
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["otherRevInfoFormat", "otherRevInfo"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["issuer", "serialNumber"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["SignerInfo.version", "SignerInfo.sid", "SignerInfo.digestAlgorithm", "SignerInfo.signedAttrs", "SignerInfo.signatureAlgorithm", "SignerInfo.signature", "SignerInfo.unsignedAttrs"]);
			//endregion
  ...
  */
   ...
   */
    ...
    */
			...
			return new Sequence({
				name: names.blockName || "",
				value: [new GeneralizedTime({ name: names.notBeforeTime || "" }), new GeneralizedTime({ name: names.notAfterTime || "" })]
			});
		}
		//**********************************************************************************
		/**
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["notBeforeTime", "notAfterTime"]);
			//endregion
   ...
   */
		toSchema() {
			//region Construct and return new ASN.1 schema for this object
			return new Sequence({
				value: [new GeneralizedTime({ valueDate: this.notBeforeTime }), new GeneralizedTime({ valueDate: this.notAfterTime })]
			});
			//endregion
		}
		//**********************************************************************************
  ...
  */
   ...
   */
    ...
    */
			...
			return new Sequence({
				name: names.blockName || "",
				value: [GeneralNames.schema(names.issuer || {}), new Integer({ name: names.serialNumber || "" }), new BitString({
					optional: true,
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["issuer", "serialNumber", "issuerUID"]);
			//endregion
  ...
  */
   ...
   */
    ...
    */
			...
			return new Sequence({
				name: names.blockName || "",
				value: [new Integer({ name: names.version || "" }), new Choice({
					value: [new Constructed({
				...
				}), AlgorithmIdentifier.schema(names.signature || {}), new Integer({ name: names.serialNumber || "" }), AttCertValidityPeriod.schema(names.attrCertValidityPeriod || {}), new Sequence({
					name: names.attributes || "",
					value: [new Repeated({
						value: Attribute.schema()
					})]
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["version", "baseCertificateID", "subjectName", "issuer", "signature", "serialNumber", "attrCertValidityPeriod", "attributes", "issuerUniqueID", "extensions"]);
			//endregion
			...
			if ("extensions" in asn1.result) this.extensions = new Extensions({ schema: asn1.result.extensions });
			//endregion
		}
		//**********************************************************************************
		/**
  ...
  */
   ...
   */
    ...
    */
			...
			return new Sequence({
				name: names.blockName || "",
				value: [AttributeCertificateInfoV1.schema(names.acinfo || {}), AlgorithmIdentifier.schema(names.signatureAlgorithm || {}), new BitString({ name: names.signatureValue || "" })]
			});
		}
		//**********************************************************************************
		/**
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["acinfo", "signatureValue", "signatureAlgorithm"]);
			//endregion
  ...
  */
   ...
   */
    ...
    */
			...
			return new Sequence({
				name: names.blockName || "",
				value: [new Enumerated({ name: names.digestedObjectType || "" }), new ObjectIdentifier({
					optional: true,
					name: names.otherObjectTypeID || ""
				}), AlgorithmIdentifier.schema(names.digestAlgorithm || {}), new BitString({ name: names.objectDigest || "" })]
			});
		}
		//**********************************************************************************
		/**
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["digestedObjectType", "otherObjectTypeID", "digestAlgorithm", "objectDigest"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["issuerName", "baseCertificateID", "objectDigestInfo"]);
			//endregion
			...
			//region Get internal properties from parsed schema
			if ("issuerName" in asn1.result) this.issuerName = new GeneralNames({ schema: asn1.result.issuerName });
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["baseCertificateID", "entityName", "objectDigestInfo"]);
			//endregion
  ...
  */
   ...
   */
    ...
    */
			...
			return new Sequence({
				name: names.blockName || "",
				value: [new Integer({ name: names.version || "" }), Holder.schema(names.holder || {}), new Choice({
					value: [GeneralNames.schema({
						names: {
							blockName: names.issuer || ""
						}
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["version", "holder", "issuer", "signature", "serialNumber", "attrCertValidityPeriod", "attributes", "issuerUniqueID", "extensions"]);
			//endregion
   ...
   */
		toSchema() {
			var result = new Sequence({
				value: [new Integer({ value: this.version }), this.holder.toSchema(), new Constructed({
					idBlock: {
						tagClass: 3, // CONTEXT-SPECIFIC
						tagNumber: 0 // [0]
					},
  ...
  */
   ...
   */
    ...
    */
			...
			return new Sequence({
				name: names.blockName || "",
				value: [AttributeCertificateInfoV2.schema(names.acinfo || {}), AlgorithmIdentifier.schema(names.signatureAlgorithm || {}), new BitString({ name: names.signatureValue || "" })]
			});
		}
		//**********************************************************************************
		/**
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["acinfo", "signatureAlgorithm", "signatureValue"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["otherCertFormat", "otherCert"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["certificates"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			...
			try {
				for (var _iterator24 = asn1.result.crls[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["TSTInfo.version", "TSTInfo.policy", "TSTInfo.messageImprint", "TSTInfo.serialNumber", "TSTInfo.genTime", "TSTInfo.accuracy", "TSTInfo.ordering", "TSTInfo.nonce", "TSTInfo.tsa", "TSTInfo.extensions"]);
			//endregion
			...
			if ("TSTInfo.extensions" in asn1.result) this.extensions = Array.from(asn1.result["TSTInfo.extensions"], element => new Extension({ schema: element }));
			//endregion
		}
		//**********************************************************************************
		/**
   ...
   */
		verify() {
			...
			// noinspection JSCheckFunctionSignatures
			sequence = sequence.then(() => crypto.digest(shaAlgorithm.name, new Uint8Array(data))).then(result => isEqualBuffer(result, this.messageImprint.hashedMessage.valueBlock.valueHex));
			//endregion
   ...
   */
    ...
    */
		...
		static defaultFindOrigin(certificate, validationEngine) {
			...
			try {
				for (var _iterator25 = validationEngine.certs[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
					var localCert = _step25.value;
			...
			try {
				for (var _iterator26 = validationEngine.trustedCerts[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
					var trustedCert = _step26.value;
		...
		defaultFindIssuer(certificate, validationEngine) {
			...
			return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
				var result, keyIdentifier, authorityCertIssuer, authorityCertSerialNumber, verificationResult, _iteratorNormalCompletion27, _didIteratorError27, _iteratorError27, _iterator27, _step27, extension, checkCertificate, _iteratorNormalCompletion29, _didIteratorError29, _iteratorError29, _iterator29, _step29, trustedCert, _iteratorNormalCompletion30, _didIteratorError30, _iteratorError30, _iterator30, _step30, intermediateCert, i, _verificationResult;
					...
					while (1) {
						switch (_context.prev = _context.next) {
								...
								checkCertificate = function checkCertificate(possibleIssuer) {
									...
									if (keyIdentifier !== null) {
										if ("extensions" in possibleIssuer) {
											...
											try {
												for (var _iterator28 = possibleIssuer.extensions[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
													var _extension = _step28.value;
							...
							case 16:
								...
								_context.prev = 20;
								_iterator27 = certificate.extensions[Symbol.iterator]();
							...
							case 44:
								...
								_context.prev = 47;
								for (_iterator29 = validationEngine.trustedCerts[Symbol.iterator](); !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
									trustedCert = _step29.value;
							...
							case 63:
								...
								_context.prev = 66;
								for (_iterator30 = validationEngine.certs[Symbol.iterator](); !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
									intermediateCert = _step30.value;
		...
		sort() {
			...
			return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
				...
				var buildPath = (() => {
					...
					return function buildPath(_x290) {
				...
				var findOCSP = (() => {
					...
					return function findOCSP(_x292, _x293) {
				...
				var checkForCA = (() => {
					...
					return function checkForCA(_x295) {
				...
				var basicCheck = (() => {
					...
					return function basicCheck(_x296, _x297) {
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["hashAlgorithm", "issuerNameHash", "issuerKeyHash", "serialNumber"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["certID", "certStatus", "thisUpdate", "nextUpdate", "singleExtensions"]);
			//endregion
			...
			if ("singleExtensions" in asn1.result) this.singleExtensions = Array.from(asn1.result.singleExtensions.valueBlock.value, element => new Extension({ schema: element }));
			//endregion
		}
		//**********************************************************************************
		/**
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["ResponseData", "ResponseData.version", "ResponseData.responderID", "ResponseData.producedAt", "ResponseData.responses", "ResponseData.responseExtensions"]);
			//endregion
			...
			if ("ResponseData.responseExtensions" in asn1.result) this.responseExtensions = Array.from(asn1.result["ResponseData.responseExtensions"].valueBlock.value, element => new Extension({ schema: element }));
			//endregion
		}
		//**********************************************************************************
		/**
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["BasicOCSPResponse.tbsResponseData", "BasicOCSPResponse.signatureAlgorithm", "BasicOCSPResponse.signature", "BasicOCSPResponse.certs"]);
			//endregion
			...
			if ("BasicOCSPResponse.certs" in asn1.result) this.certs = Array.from(asn1.result["BasicOCSPResponse.certs"], element => new Certificate({ schema: element }));
			//endregion
		}
		//**********************************************************************************
		/**
   ...
   */
		getCertificateStatus(certificate, issuerCertificate) {
			...
			sequence = sequence.then(() => {
				...
				try {
					for (var _iterator32 = this.tbsResponseData.responses[Symbol.iterator](), _step32; !(_iteratorNormalCompletion32 = (_step32 = _iterator32.next()).done); _iteratorNormalCompletion32 = true) {
						var _response = _step32.value;
						var _iteratorNormalCompletion33 = true;
						var _didIteratorError33 = false;
						var _iteratorError33 = undefined;

						try {
							for (var _iterator33 = certIDs[Symbol.iterator](), _step33; !(_iteratorNormalCompletion33 = (_step33 = _iterator33.next()).done); _iteratorNormalCompletion33 = true) {
								var id = _step33.value;
   ...
   */
    ...
    */
			function checkCA(cert) {
				...
				try {
					for (var _iterator34 = cert.extensions[Symbol.iterator](), _step34; !(_iteratorNormalCompletion34 = (_step34 = _iterator34.next()).done); _iteratorNormalCompletion34 = true) {
						var extension = _step34.value;
			...
			switch (true) {
					...
					sequence = sequence.then(() => {
						...
						try {
							for (var _iterator35 = _this.certs.entries()[Symbol.iterator](), _step35; !(_iteratorNormalCompletion35 = (_step35 = _iterator35.next()).done); _iteratorNormalCompletion35 = true) {
								var _ref8 = _step35.value;

								var _ref9 = _slicedToArray(_ref8, 2);

								var index = _ref9[0];
								var certificate = _ref9[1];
				...
				case this.tbsResponseData.responderID instanceof OctetString:
					...
					sequence = sequence.then(() => Promise.all(Array.from(_this.certs, element => crypto.digest({ name: "sha-1" }, new Uint8Array(element.subjectPublicKeyInfo.subjectPublicKey.valueBlock.valueHex)))).then(results => {
						...
						try {
							for (var _iterator36 = _this.certs.entries()[Symbol.iterator](), _step36; !(_iteratorNormalCompletion36 = (_step36 = _iterator36.next()).done); _iteratorNormalCompletion36 = true) {
								var _ref10 = _step36.value;
			...
			sequence = sequence.then(() => {
				...
				return Promise.all(Array.from(_this.certs, element => checkCA(element))).then(promiseResults => {
					...
					try {
						for (var _iterator37 = promiseResults[Symbol.iterator](), _step37; !(_iteratorNormalCompletion37 = (_step37 = _iterator37.next()).done); _iteratorNormalCompletion37 = true) {
							var promiseResult = _step37.value;
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["SignedData.version", "SignedData.digestAlgorithms", "SignedData.encapContentInfo", "SignedData.certificates", "SignedData.crls", "SignedData.signerInfos"]);
			//endregion
   ...
   */
		toSchema() {
			...
			if ("certificates" in this) {
				var certificateSet = new CertificateSet({ certificates: this.certificates });
   ...
   */
		verify() {
			var _ref12 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
			    _ref12$signer = _ref12.signer,
			    signer = _ref12$signer === undefined ? -1 : _ref12$signer,
			    _ref12$data = _ref12.data,
			    data = _ref12$data === undefined ? new ArrayBuffer(0) : _ref12$data,
			    _ref12$trustedCerts = _ref12.trustedCerts,
			    trustedCerts = _ref12$trustedCerts === undefined ? [] : _ref12$trustedCerts,
			    _ref12$checkDate = _ref12.checkDate,
			    checkDate = _ref12$checkDate === undefined ? new Date() : _ref12$checkDate,
			    _ref12$checkChain = _ref12.checkChain,
			    checkChain = _ref12$checkChain === undefined ? false : _ref12$checkChain,
			    _ref12$extendedMode = _ref12.extendedMode,
			    extendedMode = _ref12$extendedMode === undefined ? false : _ref12$extendedMode,
			    _ref12$findOrigin = _ref12.findOrigin,
			    findOrigin = _ref12$findOrigin === undefined ? null : _ref12$findOrigin,
			    _ref12$findIssuer = _ref12.findIssuer,
			    findIssuer = _ref12$findIssuer === undefined ? null : _ref12$findIssuer;
			...
			if (this.signerInfos[signer].sid instanceof IssuerAndSerialNumber) {
				sequence = sequence.then(() => {
					...
					try {
						for (var _iterator38 = this.certificates[Symbol.iterator](), _step38; !(_iteratorNormalCompletion38 = (_step38 = _iterator38.next()).done); _iteratorNormalCompletion38 = true) {
							var certificate = _step38.value;
				...
				{
					sequence = sequence.then(() => Promise.all(Array.from(this.certificates.filter(certificate => certificate instanceof Certificate), certificate => crypto.digest({ name: "sha-1" }, new Uint8Array(certificate.subjectPublicKeyInfo.subjectPublicKey.valueBlock.valueHex)))).then(results => {
						var _iteratorNormalCompletion39 = true;
						var _didIteratorError39 = false;
						var _iteratorError39 = undefined;

						try {
							for (var _iterator39 = this.certificates.entries()[Symbol.iterator](), _step39; !(_iteratorNormalCompletion39 = (_step39 = _iterator39.next()).done); _iteratorNormalCompletion39 = true) {
								var _ref13 = _step39.value;

								var _ref14 = _slicedToArray(_ref13, 2);

								var index = _ref14[0];
								var certificate = _ref14[1];
			...
			function checkCA(cert) {
				...
				if ("extensions" in cert) {
					...
					try {
						for (var _iterator40 = cert.extensions[Symbol.iterator](), _step40; !(_iteratorNormalCompletion40 = (_step40 = _iterator40.next()).done); _iteratorNormalCompletion40 = true) {
							var extension = _step40.value;
			...
			if (checkChain) {
				sequence = sequence.then(result => {
					...
					if ("crls" in this) {
						...
						try {
							for (var _iterator41 = this.crls[Symbol.iterator](), _step41; !(_iteratorNormalCompletion41 = (_step41 = _iterator41.next()).done); _iteratorNormalCompletion41 = true) {
								var crl = _step41.value;
			...
			sequence = sequence.then(result => {
				...
				if ("eContent" in this.encapContentInfo) // Attached data
					{
						if (this.encapContentInfo.eContent.idBlock.tagClass === 1 && this.encapContentInfo.eContent.idBlock.tagNumber === 4) {
							if (this.encapContentInfo.eContent.idBlock.isConstructed === false) data = this.encapContentInfo.eContent.valueBlock.valueHex;else {
								...
								try {
									for (var _iterator42 = this.encapContentInfo.eContent.valueBlock.value[Symbol.iterator](), _step42; !(_iteratorNormalCompletion42 = (_step42 = _iterator42.next()).done); _iteratorNormalCompletion42 = true) {
										var contentValue = _step42.value;
				...
				if ("signedAttrs" in this.signerInfos[signer]) {
					...
					try {
						for (var _iterator43 = this.signerInfos[signer].signedAttrs.attributes[Symbol.iterator](), _step43; !(_iteratorNormalCompletion43 = (_step43 = _iterator43.next()).done); _iteratorNormalCompletion43 = true) {
   ...
   */
	...
	function verifyPDFSignature(buffer) {
		try {
			var view = new Uint8Array(buffer);
			var pdf = new window.PDFDocument(null, view, null);
			pdf.parseStartXRef();
			pdf.parse();
			...
			var cmsContentSimp = new ContentInfo({ schema: asn1.result });
			var cmsSignedSimp = new SignedData({ schema: cmsContentSimp.content });

			var signedDataBuffer = new ArrayBuffer(byteRange[1] + byteRange[3]);
			var signedDataView = new Uint8Array(signedDataBuffer);

			var count = 0;
			for (var _i32 = byteRange[0]; _i32 < byteRange[0] + byteRange[1]; _i32++, count++) {
				signedDataView[count] = view[_i32];
			...
			if ("signedAttrs" in cmsSignedSimp.signerInfos[0]) {
				...
				sequence = sequence.then(result => {
					...
					for (var _j13 = 0; _j13 < cmsSignedSimp.signerInfos[0].signedAttrs.attributes.length; _j13++) {
						if (cmsSignedSimp.signerInfos[0].signedAttrs.attributes[_j13].type === "1.2.840.113549.1.9.4") {
							messageDigest = cmsSignedSimp.signerInfos[0].signedAttrs.attributes[_j13].values[0].valueBlock.valueHex;
							break;
						}
					}
					...
					for (var _i33 = 0; _i33 < view1.length; _i33++) {
						if (view1[_i33] !== view2[_i33]) return Promise.reject(new Error("Hash is not correct"));
					}
