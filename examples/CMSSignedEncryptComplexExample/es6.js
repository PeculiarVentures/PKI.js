...
import { arrayBufferToString, stringToArrayBuffer, bufferToHexCodes, fromBase64 } from "pvutils";
...
this.createCertificate = function ()
{
	...
	certificate.issuer.typesAndValues.push(new AttributeTypeAndValue({
		...
		value: new asn1js.BmpString({ value: that.cn })
	}));
...
//region importKey
//*********************************************************************************
this.importKey = function (importcb, failcb) {
...
//*********************************************************************************
this.createCMSSignedInternal = function ()
{
	dataBuffer = that.dataBuffer;
	//region Initial variables
	let sequence = Promise.resolve();
	let cmsSignedSimpl;
	...
	const encodedCertificate = that.cert;
...
//*********************************************************************************
this.createCMSSigned = function ()
{
	return that.createCMSSignedInternal().then(() =>
	{
...
//*********************************************************************************
function parseCMSSigned(parsecb, failcb)
{
	//region Initial check
	cmsSignedBuffer = window.cmsSignedBuffer;
	...
	window.messagedecoded = new TextDecoder("utf-8").decode(eContentInfo.eContent.valueBlock.value[0].valueBlock.valueHex);
