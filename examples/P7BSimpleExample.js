...
(function () {
		...
		sort() {
			...
			return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
				...
				var buildPath = (() => {
					...
					return function buildPath(_x288) {
				...
				var findOCSP = (() => {
					...
					return function findOCSP(_x290, _x291) {
				...
				var checkForCA = (() => {
					...
					return function checkForCA(_x293) {
				...
				var basicCheck = (() => {
					...
					return function basicCheck(_x294, _x295) {
  ...
  */
   ...
   */
	...
	//<nodewebcryptoossl>
	//*********************************************************************************
	var cmsSignedBuffer = new ArrayBuffer(0);
		...
		sequence = sequence.then(() => {
			var cmsContentSimp = new ContentInfo({
				...
				content: new SignedData({
					...
					certificates: [certSimpl, certSimpl, certSimpl] // Put 3 copies of the same X.509 certificate
				}).toSchema(true)
			});
	...
	function createP7B() {
		return Promise.resolve().then(() => createP7BInternal()).then(() => {
			...
			var resultString = document.getElementById("newSignedData").innerHTML;
			...
			hashAlgs.forEach(_hashAlg => {
				...
				it(testName, () => {
					...
					return createP7BInternal().then(() => {
						...
						var contentInfo = new ContentInfo({ schema: asn1.result });

						assert.equal(contentInfo.contentType, "1.2.840.113549.1.7.2", "Content Type ID must be '1.2.840.113549.1.7.2'");

						var signedData = new SignedData({ schema: contentInfo.content });
