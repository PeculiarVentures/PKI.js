...
(function () {
  ...
  */
   ...
   */
		...
		return cmsEnveloped.encrypt(encryptionAlgorithm, valueBuffer).then(function () {
			...
			return Promise.reject("ERROR DURING ENCRYPTION PROCESS: " + error);
		});
	}
	//*********************************************************************************
	function envelopedEncrypt() {
		return Promise.resolve().then(function () {
			...
			return envelopedEncryptInternal();
		}).then(function () {
   ...
   */
	...
	function envelopedDecrypt() {
		return Promise.resolve().then(function () {
			...
			return envelopedDecryptInternal();
		}).then(function (result) {
	...
	//*********************************************************************************
	context("How To Encrypt CMS via Password", function () {
		//region Initial variables
		...
		encAlgs.forEach(function (_encAlg) {
			encLens.forEach(function (_encLen) {
				encryptionVariants.forEach(function (_encryptionVariant) {
					...
					it(testName, function () {
						...
						return envelopedEncryptInternal().then(function () {
							return envelopedDecryptInternal();
						}).then(function (result) {
