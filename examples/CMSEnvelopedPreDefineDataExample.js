...
(function () {
	...
	function kdf(hashFunction, Zbuffer, keydatalen, SharedInfo) {
		...
		return Promise.all(kdfArray).then(incomingResult => {
			...
			while (found) {
				...
				try {
					for (var _iterator17 = incomingResult[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
			...
			if (combinedBuffer.byteLength > keydatalen) {
				...
				for (var _i17 = 0; _i17 < keydatalen; _i17++) {
					newView[_i17] = combinedView[_i17];
				}return newBuffer;
			}
   ...
   */
		isEqual(compareTo) {
			if (compareTo instanceof RelativeDistinguishedNames) {
				...
				try {
					for (var _iterator18 = this.typesAndValues.entries()[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
						var _ref = _step18.value;
  ...
  */
   ...
   */
		findPattern(pattern) {
			...
			for (var _i18 = 0; _i18 <= length - patternLength; _i18++) {
				...
				if (equal) {
					// noinspection ConditionalExpressionJS
					return backward ? start - patternLength - _i18 : start + patternLength + _i18; // Position after the pattern found
				}
			}
			//endregion
   ...
   */
    ...
    */
			...
			try {
				for (var _iterator20 = Object.keys(parameters)[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
  ...
  */
   ...
   */
		...
		isCertificateRevoked(certificate) {
			...
			try {
				for (var _iterator23 = this.revokedCertificates[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
					var revokedCertificate = _step23.value;
   ...
   */
		verify() {
			...
			if ("crlExtensions" in this) {
				...
				try {
					for (var _iterator24 = this.crlExtensions.extensions[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
  ...
  */
   ...
   */
		fromSchema(schema) {
			...
			try {
				for (var _iterator25 = asn1.result.crls[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["version", "rid", "keyEncryptionAlgorithm", "encryptedKey"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["algorithm", "publicKey"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["keyAttrId", "keyAttr"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["subjectKeyIdentifier", "date", "other"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["rid", "encryptedKey"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["RecipientEncryptedKeys"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["version", "originator", "ukm", "keyEncryptionAlgorithm", "recipientEncryptedKeys"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["keyIdentifier", "date", "other"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["version", "kekid", "keyEncryptionAlgorithm", "encryptedKey"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["version", "keyDerivationAlgorithm", "keyEncryptionAlgorithm", "encryptedKey"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["oriType", "oriValue"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["hashAlgorithm", "maskGenAlgorithm", "pSourceAlgorithm"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["keyInfo", "entityUInfo", "suppPubInfo"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["version", "originatorInfo", "recipientInfos", "encryptedContentInfo", "unprotectedAttrs"]);
			//endregion
			...
			if ("unprotectedAttrs" in asn1.result) this.unprotectedAttrs = Array.from(asn1.result.unprotectedAttrs, element => new Attribute({ schema: element }));
			//endregion
		}
		//**********************************************************************************
		/**
      ...
      */
			...
			function SubKeyTransRecipientInfo(index) {
				...
				currentSequence = currentSequence.then(() => {
					...
					var rsaOAEPParams = new RSAESOAEPParams({ schema });
        ...
        */
			...
			sequence = sequence.then(result => {
				...
				if (this.encryptedContentInfo.encryptedContent.idBlock.isConstructed === false) dataBuffer = this.encryptedContentInfo.encryptedContent.valueBlock.valueHex;else {
					...
					try {
						for (var _iterator26 = this.encryptedContentInfo.encryptedContent.valueBlock.value[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
							var content = _step26.value;
  ...
  */
   ...
   */
	...
	var preDefinedDataBuffer = new ArrayBuffer(0);
   ...
   */
		if (encryptionVariant === 1) {
			...
			if (preDefinedDataBuffer.byteLength < 32) {
				var _newPreDefinedDataBuffer = new ArrayBuffer(32);
				var _newPreDefinedDataView = new Uint8Array(_newPreDefinedDataBuffer);

				var _preDefinedDataView = new Uint8Array(preDefinedDataBuffer);

				for (var _i19 = 0; _i19 < preDefinedDataBuffer.byteLength; _i19++) {
					_newPreDefinedDataView[_i19] = _preDefinedDataView[_i19];
   ...
   */
		if (encryptionVariant === 1) {
			...
			if (preDefinedDataBuffer.byteLength < 32) {
				var _newPreDefinedDataBuffer2 = new ArrayBuffer(32);
				var _newPreDefinedDataView2 = new Uint8Array(_newPreDefinedDataBuffer2);

				var _preDefinedDataView2 = new Uint8Array(preDefinedDataBuffer);

				for (var _i20 = 0; _i20 < preDefinedDataBuffer.byteLength; _i20++) {
					_newPreDefinedDataView2[_i20] = _preDefinedDataView2[_i20];
		...
		var asn1 = fromBER(cmsEnvelopedBuffer);
		...
		encAlgs.forEach(_encAlg => {
			encLens.forEach(_encLen => {
				encryptionVariants.forEach(_encryptionVariant => {
					var testName = `${_encAlg} with ${_encLen}, ${_encryptionVariant === 2 ? "Password-based encryption" : "Pre-defined KEK"}`;
