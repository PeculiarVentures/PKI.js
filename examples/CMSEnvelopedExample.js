   ...
   */
    ...
    */
	...
	function envelopedEncryptInternal() {
		...
		return cmsEnveloped.encrypt(encAlg, valueBuffer).then(function () {
	...
	function envelopedDecryptInternal() {
		...
		return cmsEnvelopedSimp.decrypt(0, {
			...
			return Promise.reject("ERROR DURING DECRYPTION PROCESS: " + error);
		});
	}
	//*********************************************************************************
	...
	//*********************************************************************************
	context("How To Encrypt CMS via Certificate", function () {
		//region Initial variables
			...
			encLens.forEach(function (_encLen) {
				signAlgs.forEach(function (_signAlg) {
					hashAlgs.forEach(function (_hashAlg) {
						var testName = _encAlg + " with " + _encLen + ", " + _hashAlg + " + " + _signAlg;
