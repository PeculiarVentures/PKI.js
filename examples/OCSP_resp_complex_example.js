...
(function () {
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["responseType", "response"]);
			//endregion
  ...
  */
   ...
   */
		fromSchema(schema) {
			//region Clear input data first
			clearProps(schema, ["responseStatus", "responseBytes"]);
			//endregion
   ...
   */
	...
	function parseOCSPResp() {
		...
		if ("responseExtensions" in ocspBasicResp) {
			...
			for (var _i32 = 0; _i32 < ocspBasicResp.responseExtensions.length; _i32++) {
				var _typeval = extenmap[ocspBasicResp.responseExtensions[_i32].extnID];
				if (typeof _typeval === "undefined") _typeval = ocspBasicResp.responseExtensions[_i32].extnID;
		...
		for (var _i33 = 0; _i33 < ocspBasicResp.tbsResponseData.responses.length; _i33++) {
			var _typeval2 = bufferToHexCodes(ocspBasicResp.tbsResponseData.responses[_i33].certID.serialNumber.valueBlock.valueHex);
			var _subjval = "";

			switch (ocspBasicResp.tbsResponseData.responses[_i33].certStatus.idBlock.tagNumber) {
				case 0:
					_subjval = "good";
					break;
				case 1:
