   ...
   */
    ...
    */
			...
			value: function createForCertificate(certificate, parameters) {
				...
				sequence = sequence.then(function (result) {
					_this57.issuerNameHash = new OctetString({ valueHex: result });
					...
					_this57.issuerKeyHash = new OctetString({ valueHex: result });
				}, function (error) {
					return Promise.reject(error);
				});
				//endregion
    ...
    */
			...
			value: function verify() {
				...
				sequence = sequence.then(function () {
					...
					for (var _i18 = 0; _i18 < _this58.certs.length - 1; _i18++) {
						//region Check that there is "policy mapping" for level "i + 1"
						if (_i18 < _this58.certs.length - 2 && typeof policyMappings[_i18 + 1] !== "undefined") {
    ...
    */
			...
			value: function getCertificateStatus(certificate, issuerCertificate) {
				...
				sequence = sequence.then(function () {
					...
					try {
						for (var _iterator16 = _this59.tbsResponseData.responses[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
							...
							try {
								for (var _iterator17 = certIDs[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
    ...
    */
			...
			value: function sign(privateKey, hashAlgorithm) {
				...
				return crypto.sign(defParams.algorithm, privateKey, new Uint8Array(this.tbsResponseData.tbs)).then(function (result) {
					...
					_this60.signature = new BitString({ valueHex: result });
				}, function (error) {
					return Promise.reject("Signing error: " + error);
				});
				//endregion
    ...
    */
				...
				if (responderType === 0) // By Name
					{
						sequence = sequence.then(function () {
							...
							try {
								for (var _iterator18 = _this61.certs.entries()[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
					...
					{
						sequence = sequence.then(function () {
							return Promise.all(Array.from(_this61.certs, function (element) {
								...
								try {
									for (var _iterator19 = _this61.certs.entries()[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
										var _step19$value = _slicedToArray(_step19.value, 2);

										var index = _step19$value[0];
										var certificate = _step19$value[1];
     ...
     */
				...
				sequence = sequence.then(function () {
					...
					signerCert = _this61.certs[certIndex];
					...
					return Promise.all(Array.from(_this61.certs, function (element) {
						...
						try {
							for (var _iterator21 = promiseResults[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
								var promiseResult = _step21.value;
				...
				sequence = sequence.then(function () {
					//region Get information about public key algorithm and default parameters for import
					var algorithmId = void 0;
					if (_this61.certs[certIndex].signatureAlgorithm.algorithmId === "1.2.840.113549.1.1.10") algorithmId = _this61.certs[certIndex].signatureAlgorithm.algorithmId;else algorithmId = _this61.certs[certIndex].subjectPublicKeyInfo.algorithm.algorithmId;
					...
					if (algorithmName === "ECDSA") {
						//region Get information about named curve
						if (_this61.certs[certIndex].subjectPublicKeyInfo.algorithm.algorithmParams instanceof ObjectIdentifier === false) return Promise.reject("Incorrect type for ECDSA public key parameters");

						var curveObject = getAlgorithmByOID(_this61.certs[certIndex].subjectPublicKeyInfo.algorithm.algorithmParams.valueBlock.toString());
						if ("name" in curveObject === false) return Promise.reject("Unsupported named curve algorithm: " + _this61.certs[certIndex].subjectPublicKeyInfo.algorithm.algorithmParams.valueBlock.toString());
						//endregion
					...
					var publicKeyInfoSchema = _this61.certs[certIndex].subjectPublicKeyInfo.toSchema();
					var publicKeyInfoBuffer = publicKeyInfoSchema.toBER(false);
					var publicKeyInfoView = new Uint8Array(publicKeyInfoBuffer);
				...
				sequence = sequence.then(function (publicKey) {
					...
					//region Special case for ECDSA signatures
					var signatureValue = _this61.signature.valueBlock.valueHex;
    ...
    */
	...
	function parseOCSPResp() {
		...
		if ("responseExtensions" in ocspBasicResp) {
			...
			for (var _i25 = 0; _i25 < ocspBasicResp.responseExtensions.length; _i25++) {
				var _typeval = extenmap[ocspBasicResp.responseExtensions[_i25].extnID];
				if (typeof _typeval === "undefined") _typeval = ocspBasicResp.responseExtensions[_i25].extnID;
		...
		for (var _i26 = 0; _i26 < ocspBasicResp.tbsResponseData.responses.length; _i26++) {
			var _typeval2 = bufferToHexCodes(ocspBasicResp.tbsResponseData.responses[_i26].certID.serialNumber.valueBlock.valueHex);
			var _subjval = "";

			switch (ocspBasicResp.tbsResponseData.responses[_i26].certStatus.idBlock.tag_number) {
				case 0:
					_subjval = "good";
					break;
				case 1:
