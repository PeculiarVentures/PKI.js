...
export type ExtensionParsedValue =
...
export class ExtensionValueFactory {
  ...
  private static getItems(): Record<string, ExtensionValueType> {
    if (!this.types) {
      ...
      ExtensionValueFactory.register(
        OID.id_AuthorityKeyIdentifier,
      ...
      ExtensionValueFactory.register(
        OID.id_CertificatePolicies,
        "CertificatePolicies",
        CertificatePolicies,
      );
      ExtensionValueFactory.register(
        OID.id_MicrosoftAppPolicies,
        "CertificatePoliciesMicrosoft",
        CertificatePolicies,
      );
      ExtensionValueFactory.register(
        OID.id_MicrosoftCertTemplateV2,
        "MicrosoftCertTemplateV2",
        CertificateTemplate,
      );
      ExtensionValueFactory.register(
        OID.id_CRLDistributionPoints,
