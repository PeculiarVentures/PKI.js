...
describe("CMS Signed Complex Example", () => {
      ...
      addExts.forEach((addExt) => {
        detachedSignatures.forEach((detachedSignature) => {
          ...
          it(testName, async () => {
            ...
            const result = await example.verifyCMSSigned(
              cms.cmsSignedData,
              [cms.certificate],
